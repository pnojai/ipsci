...
```{r} 
p<-inner_join(patents, abs_topic_docs, by = c("docId")) 
...
```{r} 
subset(abs_topics_term, topic==p$docId)$term
```


```{r} 
subset(abs_topics_term, topic==1)$term
```
