...
patents <- patents %>%
  ...
  mutate(title=str_replace_all(title,'apparatus|control|device|include.*|provide.*|methods*|systems*','')) %>%
  ...
  mutate(abstract=str_replace_all(abstract,'apparatus|control|device|include.*|provide.*|methods*|systems*','')) %>%
