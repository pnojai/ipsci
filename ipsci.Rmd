...
### select relevant patent data from USPTO
```{r}
# explore downloaded data
raw.json <- fromJSON(file = "data/US09822470.json")
print(raw.json)
# title
title.json <- raw.json$title
# appID
appId.json <- raw.json$applicationNumber
# inventor
inventor.json <- raw.json$inventor
#
```
...
# description > summary of the invention --> worth grabbing?
# cited by 
...
files <- list.files(path="sample_data", pattern="*.html", full.names=TRUE, recursive=FALSE)
