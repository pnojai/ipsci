...
# deal with dates, then get date quartiles for facet plotting
#lct <- Sys.getlocale("LC_TIME"); Sys.setlocale("LC_TIME", "C")
#raw.df$filingDate <- raw.df$filingDate %>% strptime(format = "%y-%m-%d")
#raw.df$filingDate <- raw.df$filingDate %>% as.Date(format = "%y/%m/%d")
